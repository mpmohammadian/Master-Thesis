...
# plot(K_X_unmark$r/1000,K_X_unmark$est/1000,type="n",ylim = c(0,max(R_up)),xlab = "r",ylab = "K") #,xlim=c(50,150),ylim=c(0.045,0.05))
# lines(K_X_unmark$r/1000,R_up,col="white")
# lines(K_X_unmark$r/1000,R_low,col="white")
# polygon(c(K_X_unmark$r/1000, rev(K_X_unmark$r/1000)), c(R_up, rev(R_low)),col = "grey90", border = NA)
# points(K_X_unmark$r/1000,K_X_unmark$est/1000,type="l",col="black",lwd=2) #,xlim=c(50,150),ylim=c(0.045,0.05))
# lines(K_X_unmark$r/1000,K_X_unmark$theo/1000,col="red",lwd=2,lty=2)
